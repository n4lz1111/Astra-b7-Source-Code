...
LOAD_RESOURCE(packet_off_wav);
LOAD_RESOURCE(packet_on_wav);
LOAD_RESOURCE(raven_off_wav);
LOAD_RESOURCE(raven_on_wav);
LOAD_RESOURCE(seven_days_png);
LOAD_RESOURCE(sigma250_off_wav);
LOAD_RESOURCE(sigma250_on_wav);
