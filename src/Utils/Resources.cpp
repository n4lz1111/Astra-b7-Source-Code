...
void ResourceLoader::loadResources() {
    ...
    auto packet_off_wav = GET_RESOURCE(packet_off_wav);
    Resources.emplace("packet_off.wav", packet_off_wav);
    auto packet_on_wav = GET_RESOURCE(packet_on_wav);
    Resources.emplace("packet_on.wav", packet_on_wav);
    auto raven_off_wav = GET_RESOURCE(raven_off_wav);
    Resources.emplace("raven_off.wav", raven_off_wav);
    auto raven_on_wav = GET_RESOURCE(raven_on_wav);
    Resources.emplace("raven_on.wav", raven_on_wav);
    auto seven_days_png = GET_RESOURCE(seven_days_png);
    Resources.emplace("seven_days.png", seven_days_png);
    auto sigma250_off_wav = GET_RESOURCE(sigma250_off_wav);
    Resources.emplace("sigma250_off.wav", sigma250_off_wav);
    auto sigma250_on_wav = GET_RESOURCE(sigma250_on_wav);
    Resources.emplace("sigma250_on.wav", sigma250_on_wav);
