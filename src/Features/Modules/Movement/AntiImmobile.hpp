...
public:
    ...
    EnumSettingT<Mode> mMode = EnumSettingT<Mode>("Mode", "The mode of the module", Mode::Normal, "Normal", "Clip", "Valkyrie5.0");
    ...
    bool inSkyWars = false;
    bool noPacketActive = false;
