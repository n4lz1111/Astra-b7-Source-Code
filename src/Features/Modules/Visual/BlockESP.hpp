...
public:
    ...
    BoolSetting mEmerald = BoolSetting("Emerald", "Draws around emerald ore", false);
    BoolSetting mDiamond = BoolSetting("Diamond", "Draws around diamond ore", true);
    BoolSetting mGold = BoolSetting("Gold", "Draws around gold ore", false);
    BoolSetting mIron = BoolSetting("Iron", "Draws around iron ore", false);
    BoolSetting mCoal = BoolSetting("Coal", "Draws around coal ore", false);
    ...
    BoolSetting mPortal = BoolSetting("Portal", "Draws around portal blocks", false);
    BoolSetting mChests = BoolSetting("Chests", "Draws around chests", true);
	BoolSetting mBed = BoolSetting("Bed", "BedESP", true);
    BoolSetting mHiveBed = BoolSetting("HiveBed", "Hive Bed ESP (Mega Bedwars not supported)", true);
