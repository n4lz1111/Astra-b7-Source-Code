...
void Watermark::onRenderEvent(RenderEvent& event)
{
    ...
    /*if (mStyle.mValue == Style::AstraVersion)
    {
        ...
        ImGui::PopFont(); // ウォーターマーク用のフォントを戻す
    ...
    if (mStyle.mValue == Style::Packet)
{
    ...
    static std::string watermarkText = "Packet"; // ← ここが Packet
    ...
    if (mStyle.mValue == Style::PacketClient)
{
    ...
    static std::string watermarkText = "Packet Client"; // ← ここを変更
    static float size = 45;
    ...
    if (mStyle.mValue == Style::aaaclient)
    {
        ...
        static std::string watermarkText = "aaa client"; // ← ここが Packet
        static float size = 45;
    ...
    if (mStyle.mValue == Style::Solstice)
    {
        ...
        static std::string watermarkText = "solstice"; // ← ここが Packet
        static float size = 45;
