...
public:
    ...
    EnumSettingT<Style> mStyle = EnumSettingT<Style>("Style", "The style of the watermark.", Style::AstraVersion, "Astra Client", "Astra Version", "7 Days", "Packet", "Packet Client", "aaaclient", "Solstice");
