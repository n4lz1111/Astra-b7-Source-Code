...
public:
    ...
    EnumSettingT<Style> mStyle = EnumSettingT("Style", "The style of the target HUD", Style::Solstice, "Astra");
	...
	BoolSetting mTracking = BoolSetting("Tracking", "Track players even when not targeted", false);
    ...
    glm::vec3 trackedPos;   // ìGÇÃà íu
    bool isTracking = false; // í«è]íÜÇ©Ç«Ç§Ç©
};