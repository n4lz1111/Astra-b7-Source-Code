...
class Fucker : public ModuleBase<Fucker> {
public:
    ...
    BoolSetting mIron = BoolSetting("Egg", "Destroy iron ore", false);
    EnumSettingT<OrePriority> mIronPriority = EnumSettingT<OrePriority>("Iron Priority", "Cube Craft Egg Wars", OrePriority::Medium, "High", "Medium", "Low");
    BoolSetting mCoal = BoolSetting("Bednuker", "bednuke", false);
    EnumSettingT<OrePriority> mCoalPriority = EnumSettingT<OrePriority>("BedNuker Priority", "Recommended : Low", OrePriority::Medium, "High", "Medium", "Low");
    BoolSetting mRedstone = BoolSetting("Endstone", "Destroy endstone Nexus", false);
    EnumSettingT<OrePriority> mRedstonePriority = EnumSettingT<OrePriority>("Endstone Priority", "Recommended : Low", OrePriority::Medium, "High", "Medium", "Low");
    ...
    Fucker() : ModuleBase("Fucker", "Automatically breaks ores", ModuleCategory::Player, 0, false) {
